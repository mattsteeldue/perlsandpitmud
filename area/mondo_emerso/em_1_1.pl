...
# Study-room used to buld the VirtualRoom.pm object.
...
sub new {
    ...
    # so 'entra' substitutes 'ovest'.
    $self->add_exit('entra', 'area/salazar/room/bassi_e2');
    $self->remove_exit('est', 'area/salazar/room/bassi_e2');
