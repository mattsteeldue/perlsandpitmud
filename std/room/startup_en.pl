...
sub display_step6 { 
    ...
    push @outp, ( "You cannot see colours.\n" ) unless $pl->ansi_color;
    push @outp, ( parse_color("You can see " .
                  "{Red}c{Yellow}ou{Green}lo{Blue}rs{NORMAL}.\n" ) ) if $pl->ansi_color;
    push @outp, ( "You accept the rules of this MUD.\n" ) ;
    push @outp, ( "\n" );
